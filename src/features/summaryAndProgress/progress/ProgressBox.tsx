...
const ProgressBox = memo(({ progress }: { progress: Progress }) => {
    ...
    const memoClassName = `${memoBaseClassName} ${
        bgClassNameDict[progress.completed]
    }`
        ...
        <MemoCard onClick={handleClick} className={memoClassName}>
            <p
                className={`break-keep ${
                    plainFontClassNameDict[progress.completed]
                }`}
            >
                {progress.stepTitle}
            </p>
            <div className="flex justify-between">
                <p
                    className={`break-keep ${styleClassName.fontJustBold} ${
                        accentFontClassNameDict[progress.completed]
                    }`}
                >
                    {progress.questionGroupDescription}
                </p>
                {progress.completed !== "NOT_STARTED" && (
                    ...
                    >
                        {completedInKorean[progress.completed]}
                    </p>
                )}
            </div>
        </MemoCard>
