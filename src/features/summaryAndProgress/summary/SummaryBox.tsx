...
export const SummaryBoxContent = ({
    ...
    return (
        <>
            <p
                className={`break-keep ${styleClassName.fontVividInverted} ${styleClassName.fontJustBold}`}
            >
                {progress?.bookTitle}
            </p>
            <p className={`break-keep ${styleClassName.fontMutedInverted}`}>
                {progress?.stepTitle}
            </p>
            ...
            <div className="flex justify-between">
                ...
                <p className={`self-end ${styleClassName.fontMutedInverted}`}>
...
const SummaryBox = ({ progress }: { progress: Progress }) => {
    ...
    const isDraggingClassName = isDragging
        ...
        : `${inProgressStatusToBg[progress.inProgressStatus]}`
